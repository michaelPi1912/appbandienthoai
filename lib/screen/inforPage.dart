          ...
          if (snapshot.hasData) {
                    return Column(
                            children: [
                                  ...
                                  children: [
                                    ...
                                    TableRow(children: [
                                      const Align(
                                        ...
                                        child: Text("Address:")),
                                      // Text(""),
                                      Text("${snapshot.data!.address![0].addressDetail},${snapshot.data!.address![0].district},${snapshot.data!.address![0].province}"),
                                      IconButton(
                                          onPressed: () {
                              ...
                              ElevatedButton(
                                onPressed: () async {
                                  String rs = await Navigator.push(context, MaterialPageRoute(builder: (context) => const UpdatePage()));
                                  if(rs == "update"){
                                    setState(() {
                                      user = fetchUser(token!);
                                    });
